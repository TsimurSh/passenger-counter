...
public class CounterController {
    ...
    public Map<String, DeviceSnapshotDto> getDeviceAndruino() {
    ...
    public String uploadDeviceAndruino(@org.springframework.web.bind.annotation.RequestBody DeviceSnapshotDto snapshot) {
